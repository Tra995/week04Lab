...
public class StringBuilderListSetMap {
	...
	public static void main(String[] args) {
		...
		//			and returns the shortest string
			System.out.println(findShorestString(strings));
		...
		// 			separated by a comma
			System.out.println(combinedString(swapped));
		...
		//			and returns a list of integers that contains the length of each string
			List<Integer> stringsLength = calculateStringLengths(strings);
		...
		dictionary.put("Banana","A yellow friut which you peel before eating");
		dictionary.put("Java", "A programing language created in 1995 and still heavily used today");
	...
	// Method 5:
	public static String combinedString(List<String> strings) {
	...
	// Method 3:
	public static String findShorestString(List<String> list) {
